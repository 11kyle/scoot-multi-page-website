...
export default function GooglePlay({...props}: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="182" height="56" viewBox="0 0 182 56" {...props}>
